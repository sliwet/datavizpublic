    ...
    For Each ws In Worksheets
        ...
        For i = 2 To lastrow
            If ws.Cells(i, 1) <> ticker Then
                ...
                ws.Cells(recordidx, 10).Value = priceEnd - priceBegin
                ...
                If priceBegin > 0 Then
                    ws.Cells(recordidx, 11).Value = (priceEnd - priceBegin) / priceBegin
                Else
